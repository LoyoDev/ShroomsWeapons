using ShroomsWeapons.Items.Weapons;
...
{
	public class DarkPrismHoldout : ModProjectile
	{
		...
		private void FireBeams()
		{
			...
			for (int b = 0; b < NumBeams; ++b) {
				Projectile.NewProjectile(projectile.Center, beamVelocity, ModContent.ProjectileType<DarkPrismBeam>(), damage, knockback, projectile.owner, b, uuid);
			}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Color drawColor = DarkPrism.OverrideColor;
